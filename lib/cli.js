...
(function() {
  ...
  programm.version(pkg.version).usage('[option] <file> | <directory>').option('-e, --exclude <regex>', 'regular expression to exclude files and folders').option('-i, --include <regex>', 'regular expression to include files and folders').option('-f, --format <format>', 'format output:' + ((function() {
    var results;
    results = [];
    for (k in fmts) {
      results.push(" " + k);
